...
CREATE TABLE wuyu_score (
   ...
   character_ethics FLOAT(5, 2) NOT NULL COMMENT '品德评定',
   rewards_punishments FLOAT(5, 2) NOT NULL COMMENT '奖惩记录',
   moral_education_courses FLOAT(5, 2) NOT NULL COMMENT '德育课程',
   practical_activities FLOAT(5, 2) NOT NULL COMMENT '实践活动',
   online_culture FLOAT(5, 2) NOT NULL COMMENT '网络文化',
   interpersonal_relationships FLOAT(5, 2) NOT NULL COMMENT '人际关系',
   prep_management FLOAT(5, 2) NOT NULL COMMENT '预习管理',
   plan_management FLOAT(5, 2) NOT NULL COMMENT '计划管理',
   classroom_behavior FLOAT(5, 2) NOT NULL COMMENT '课堂行为',
   classroom_attendance FLOAT(5, 2) NOT NULL COMMENT '课堂考勤',
   homework_management FLOAT(5, 2) NOT NULL COMMENT '作业管理',
   review_management FLOAT(5, 2) NOT NULL COMMENT '复习管理',
   personal_abilities FLOAT(5, 2) NOT NULL COMMENT '个人能力',
   academic_performance FLOAT(5, 2) NOT NULL COMMENT '学业成绩',
   experimental_competitions FLOAT(5, 2) NOT NULL COMMENT '实验竞赛',
   examination_metrics FLOAT(5, 2) NOT NULL COMMENT '体检指标',
   physical_fitness_scores FLOAT(5, 2) NOT NULL COMMENT '体能成绩',
   sporting_specialties FLOAT(5, 2) NOT NULL COMMENT '体育特长',
   healthy_living FLOAT(5, 2) NOT NULL COMMENT '健康生活',
   mental_qualities FLOAT(5, 2) NOT NULL COMMENT '心理素质',
   physical_education_courses FLOAT(5, 2) NOT NULL COMMENT '体育课程',
   arts_courses FLOAT(5, 2) NOT NULL COMMENT '美育课程',
   arts_achievements FLOAT(5, 2) NOT NULL COMMENT '美育成果',
   arts_activities FLOAT(5, 2) NOT NULL COMMENT '美育活动',
   labor_practices FLOAT(5, 2) NOT NULL COMMENT '劳动实践',
   labor_courses FLOAT(5, 2) NOT NULL COMMENT '劳动课程',
   comprehensive_score FLOAT(5,2) COMMENT '五育综合成绩',
...
INSERT INTO sys_menu (id, pid, name, url, permissions, menu_type, icon, sort, creator, create_date, updater, update_date) VALUES (1067246875800000003, 1067246875800000055, '新增', NULL, 'sys:user:save,sys:school:list,sys:role:list', 1, NULL, 1, 1067246875800000001, now(), 1067246875800000001, now());
INSERT INTO sys_menu (id, pid, name, url, permissions, menu_type, icon, sort, creator, create_date, updater, update_date) VALUES (1067246875800000004, 1067246875800000055, '修改', NULL, 'sys:user:update,sys:school:list,sys:role:list', 1, NULL, 2, 1067246875800000001, now(), 1067246875800000001, now());
...
INSERT INTO sys_menu (id, pid, name, url, permissions, menu_type, icon, sort, creator, create_date, updater, update_date) VALUES (1067246875800000017, 1067246875800000012, '删除', NULL, 'sys:school:delete', 1, NULL, 3, 1067246875800000001, now(), 1067246875800000001, now());
